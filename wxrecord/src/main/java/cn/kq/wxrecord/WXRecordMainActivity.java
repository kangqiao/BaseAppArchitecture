 ...
 */
public class WXRecordMainActivity extends BaseActivity implements View.OnClickListener{
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.iv_back) {
            ...
            Intent intent = new Intent(WXRecordMainActivity.this, EditVideoActivity.class);
