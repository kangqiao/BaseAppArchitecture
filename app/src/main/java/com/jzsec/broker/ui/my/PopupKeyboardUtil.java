...
public class PopupKeyboardUtil {
    ...
    public PopupKeyboardUtil(Activity mActivity) {
        ...
        this.keyboard = new Keyboard(mActivity, R.xml.stock_price_num_keyboard);
    }
    ...
    public void showSoftKeyboard() {
        ...
        mRootView = (FrameLayout) mActivity.getWindow().getDecorView();
        ...
        mRootView.addView(viewContainer, lp);
        //viewContainer.setVisibility(View.GONE);
        Rect rect =new Rect();
        mRootView.getWindowVisibleDisplayFrame(rect);
        int[] location =new int[2];
        editText1.getLocationOnScreen(location);
        Zlog.d("keyoard", "location[1]="+location[0] + ", location[1]="+location[1]+", viewC.height="+viewContainer.getHeight()+", editT.height="+editText1.getHeight()+", rect.bottom="+rect.bottom);
        mMoveHeight = (location[1] +viewContainer.getHeight()+editText1.getHeight()) - rect.bottom;
