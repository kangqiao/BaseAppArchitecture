...
public class StringUtil {
    private static final java.lang.String TAG = "StringUtil";
    ...
    public static String redWrap(String content) {
        return "<font color='#f55754'>" + content + "</font>";
    }

    public static String greenWrap(String content) {
        return "<font color='#00a93d'>" + content + "</font>";
    }
     ...
     * @return
     */
    public static String millisecsToDateString(long date) {
     ...
     * 例如: "你好" => "N" ,   "_你好" => "#"//如果def="#"时.
     *
     * @param content 初始的字符(中文, 英文, 特殊符号...)
