package com.jzsec.broker.view.layout;
...
import com.jzsec.broker.base.BaseEntity;
import com.jzsec.broker.base.BaseViewHolder;
import com.jzsec.broker.base.RxManager;
import com.jzsec.broker.data.Data;
import com.jzsec.broker.utils.LogUtil;
import com.jzsec.broker.view.viewholder.CommFooterVH;
...
public class TRecyclerView<T extends BaseEntity.ListBean> extends LinearLayout {
    ...
    private void initView(Context context) {
        ...
        mRxManager.on(GlobalConfig.EVENT_DEL_ITEM, (arg0) -> mCommAdapter.removeItem((Integer) arg0));
        mRxManager.on(GlobalConfig.EVENT_UPDATE_ITEM, (arg0) -> mCommAdapter.upDateItem(((UpDateData) arg0).i, ((UpDateData) arg0).oj));
    ...
    public TRecyclerView setHeadView(Class<? extends BaseViewHolder> cla) {
        if (cla == null) {
            ...
            try {
                Object obj = ((Activity) context).getIntent().getSerializableExtra(GlobalConfig.HEAD_DATA);
    ...
    public class CoreAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public void setBeans(List<T> datas, int begin) {
            ...
            this.isHasMore = datas.size() >= GlobalConfig.PAGE_COUNT;
            if (begin > 1) {
